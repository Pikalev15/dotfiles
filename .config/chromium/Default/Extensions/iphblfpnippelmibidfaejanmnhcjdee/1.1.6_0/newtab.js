...
btn.addEventListener("click", open);
  ...
  if (donateBtn) {
    donateBtn.addEventListener("click", () => {
      window.open("https://www.paypal.com/donate/?hosted_button_id=L9ZP8FMUMSTCA", "_blank");
    });
  }
...
function initFirstTimeTutorial() {
  ...
  if (!modal || !closeBtn || !gotItBtn || !video) {
    return;
  }
